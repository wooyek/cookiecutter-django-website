...
if os.environ["DJANGO_SETTINGS_MODULE"] == "website.settings":
    ...
    if len(sys.argv) > 1 and sys.argv[1] == 'test':
        ...
        logging.info("Module website.settings is loading local settings. Set DJANGO_SETTINGS_MODULE to override this.")
        from .local import *
